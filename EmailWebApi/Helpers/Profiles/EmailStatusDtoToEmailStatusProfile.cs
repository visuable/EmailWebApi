...
{
    public class EmailStatusDtoToEmailStatusProfile : Profile
    {
        public EmailStatusDtoToEmailStatusProfile()
        {
            CreateMap<EmailStatusDto, EmailStatus>().ForMember(x => x.IsArrived, y => y.MapFrom(z => z.IsArrived))
